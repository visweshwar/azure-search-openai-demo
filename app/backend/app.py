...
storage_azure_credential = DefaultAzureCredential()
search_azure_credential=AzureKeyCredential(str(os.getenv("AZURE_SEARCH_API_KEY")))
...
search_client = SearchClient(
    ...
    credential=search_azure_credential)
